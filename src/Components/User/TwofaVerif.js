...
function TwofaVerif() {
    ...
    const handleVerify2FA = async () => {
      try {
        ...
        const response = await verify2FA(id);
    ...
    return ( <><div className="inner-page-banner">
...
<button  className="account-btn" onClick={handleVerify2FA}>Verify Two-Factor Authentication</button>
<p>{message}</p>
</div>
</div>
</div>
