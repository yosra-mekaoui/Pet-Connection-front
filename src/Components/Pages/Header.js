...
function Header() {
    ...
    <div className="container-fluid d-flex justify-content-between align-items-center">
      <div className="header-logo">
        <a href="index.html"><img alt="image" className="img-fluid" src="assets/images/logo-01.png" height={50} width={50}/></a>
      </div>
        ...
        <div className="for-mobile-menu d-lg-none d-block">
          ...
          <form className="mobile-menu-form">
            <div className="input-with-btn d-flex flex-column">
              ...
              <button className="primary-btn2" type="submit">Search</button>
            </div>
          </form>
        </div>
      </div>
